...
class QAGenerator:
    ...
    def generate_qa_pairs(
        self, text_file: Union[str, Path], num_pairs: int = 10
    ) -> List[Dict[str, str]]:
        """
    ...
    def split_train_test(
        self, qa_pairs: List[Dict[str, str]], test_ratio: float = 0.2
    ...
    def batch_generate(
        self, processed_dir: Union[str, Path], num_pairs_per_file: int = 10
    ) -> List[Dict[str, str]]:
        """
